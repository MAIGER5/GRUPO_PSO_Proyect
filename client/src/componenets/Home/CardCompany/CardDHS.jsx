import { Box, Button, Card, CardContent, CardMedia, Typography, createTheme } from "@mui/material"
import compania from '../../../utils/LogoDHS.png'
      ...
      <Link to={'/Dhs'}>
          ...
          >
              ...
              <CardContent>
                  ...
                  />
                  <Typography  variant="body2" align="center"  fontWeight={'bold'} color="#ffff" marginTop={4}> DHS </Typography>
