import { Avatar, Box, Button, Card, CardContent, CardMedia, Typography, createTheme } from "@mui/material"
import compania from '../../../utils/LogoPso.png'
          ...
          >
              ...
              <CardContent>
                  <Avatar alt="Remy Sharp" src={compania}
                    ...
                    imgProps={{ style: { width: "4.375rem", height: "2.875rem" } }}
                  />
                  <Typography  variant="body2" align="center"  fontWeight={'bold'} color="#ffff" marginTop={4}> PSO </Typography>
